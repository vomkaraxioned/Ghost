...
const post_events_2 = require("@tryghost/post-events");
    ...
    subscribeToEvents() {
        this.DomainEvents.subscribe(PostDeletedEvent_1.PostDeletedEvent, async (event) => {
            ...
            try {
                ...
                logging_1.default.error({ err, message: 'Error handling PostDeletedEvent' });
            }
        });
        ...
        this.DomainEvents.subscribe(post_events_2.PostsBulkDestroyedEvent, async (event) => {
            logging_1.default.info(`BulkDestroyEvent received, removing posts ${event.data} from all collections`);
            try {
                await this.removePostsFromAllCollections(event.data);
                /* c8 ignore next 3 */
            }
            catch (err) {
                logging_1.default.error({ err, message: 'Error handling PostsBulkDestroyedEvent' });
            }
        });
